    ...
    <template x-if="nav">
        <div class="flex justify-end">
            <ol class="flex flex-col bg-wsblue-100 text-white py-2 w-full text-lg">
                ...
                <li class="p-2 border-b-2 border-white">
                    <a class="w-full flex justify-end" href="/get-involved">
                        get involved
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 ml-2" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li class="p-2 border-b-2 border-white">
                    <a class="w-full flex justify-end" href="/terms-and-conditions">
                ...
                <li class="p-2 border-white">
                    <a class="w-full flex justify-end" href="apply">
                        apply
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 ml-2" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
